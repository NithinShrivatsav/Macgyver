...
## filename is the location of object descriptors extracted using ESF
filename = '/home/nithins/Desktop/ThreeDCV/SHOTC/build/shotc_descriptors_final_new_seven.csv'
...
joblib.dump(mlp,"NN_SHOTC.joblib")
